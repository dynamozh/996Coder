...
def get_results(model,device, class_names,permission, frame, CountArea,colorDict):
    ...
    #     cv2.putText(frame, str(num_dict[objectName]) + "_" + objectName, (x1 - 1, y1 - 3.carIdentification), cv2.FONT_HERSHEY_COMPLEX, 0.7,
    #                 boxColor,
    #                 thickness=2)
...
if __name__ == '__main__':
    ...
    # plt.title('BGR')
    # plt.show()
    objects, outimg = run(img_BGR, CountArea)